var searchFeed = function(url){
	chrome.tabs.create({url: 'https://digg.com/reader/search/' + encodeURIComponent(url)});
};

var onClick = function(event){
	searchFeed(event.target.href);
};
